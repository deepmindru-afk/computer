...
>
	{#if !isLanding}
		...
		>
			<div
				aria-hidden="true"
				class="pointer-events-none absolute inset-0 -bottom-10 -z-10 bg-linear-to-b from-white/90 via-40% via-white/50 to-97% to-transparent dark:from-gray-900/90 dark:via-gray-900/50 dark:to-transparent"
			></div>
			<div
